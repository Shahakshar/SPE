...
const AppointmentDetail = () => {
  ...
  const getAppointmentIdFromUrl = () => {
    ...
    return pathSegments[pathSegments.indexOf("appointments") + 1];
  };
  ...
  const shouldShowJoinWarning = (appointment) => {
  ...
  const handleJoinMeeting = () => {
    ...
    // Generate room ID using appointment details
    const roomId = `appointment-${appointment.id}`;
    const userId = user.id;
    const userName = user.name;

    // Navigate to the video room
    window.location.href = `/room/${roomId}/${userId}/${userName}`;
  };
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">
                        {appointment.serviceName || "Medical Consultation"}
                      </div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">
                        Dr. {appointment.doctorName || "Smith"}
                      </div>
                      <div className="text-gray-500 text-sm">
                        {appointment.doctorSpecialty || "General Practitioner"}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {isPending(appointment) && (
            <div className="mt-8">
              <button
                ...
                className="w-full py-3 rounded-lg flex items-center justify-center font-medium bg-green-600 text-white hover:bg-green-700"
              >
                <Video size={20} className="mr-2" />
                Join Video Consultation
              </button>
              {shouldShowJoinWarning(appointment) && (
                <p className="text-sm text-center text-amber-600 mt-2">
                  ⚠️ Note: The ideal time to join is 5 minutes before your
